                      ...
                      <div class="row">
                          <div class="col-lg-6">
                              ...
                              <div class="product-thumbs">
                                  <carousel class="product-thumbs-track ps-slider" :autoplay="false" :nav="false" :dots="false">
...
import HeaderMdvx from '@/components/HeaderMdvx.vue';
import MiniProduct from '../components/MiniProduct.vue';
import FooterMdvx from '../components/FooterMdvx.vue';
